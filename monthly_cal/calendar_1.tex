...
\usepackage{fontawesome} % Use fontawesome symbols
...
\newcommand{\foo}{
  \textcolor{blue}{\faBook}
}

\day{Work}{\mood \mood \foo \eventskip 12pm TPS Report Due}
\day{Work}{9am Team Standup Meeting \eventskip \dayheader{Social}{}\eventskip 5:30pm Tennis with John, Janet and James}
\day{}{\vspace{2.5cm}} % 3
\day{}{\vspace{2.5cm}} % 4
\day{}{\vspace{2.5cm}} % 5
\day{}{\vspace{2.5cm}} % 6
